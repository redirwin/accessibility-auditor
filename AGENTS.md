...
- [execute-plan](.agents/skills/execute-plan/SKILL.md) — Use this skill when the user asks to execute an existing implementation plan (for example `execute plan`, “proceed to section 3”, or “run sections 5 through 9”). This skill enforces section-scoped implementation, supports both single-section and batched-section execution, requires plan checkbox updates and implementation notes, and requires validation/reporting before requesting confirmation to continue.
